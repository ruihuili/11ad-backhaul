...
WifiMode WifiTxVector::GetMode (void) const
{
...
uint8_t WifiTxVector::GetTxPowerLevel (void) const
{
...
uint8_t WifiTxVector::GetRetries (void) const
{
    return m_retries;
}

bool WifiTxVector::IsShortGuardInterval (void) const
{
    return m_shortGuardInterval;
}

uint8_t WifiTxVector::GetNss (void) const
{
    return m_nss;
}

uint8_t WifiTxVector::GetNess (void) const
{
    return m_ness;
}

bool WifiTxVector::IsStbc (void) const
{
    return m_stbc;
}
...
void WifiTxVector::SetRetries (uint8_t retries)
{
    m_retries = retries;
}

void WifiTxVector::SetShortGuardInterval (bool guardinterval)
{
    m_shortGuardInterval=guardinterval;
}

void WifiTxVector::SetNss(uint8_t nss)
{
    m_nss= nss;
}

void WifiTxVector::SetNess(uint8_t ness)
{
    m_ness=ness;
}

void WifiTxVector::SetStbc(bool stbc)
{
    m_stbc=stbc;
}
