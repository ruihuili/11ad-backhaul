...
public:
  ...
  void SetExtendedRateMode(uint16_t val) {m_ExtendedRateMode = val;}
  uint16_t GetExtendedRateMode() const {return m_ExtendedRateMode;}

  void SetDmgOfdm(bool dmgOfdm);
  bool GetDmgOfdm(void) const;
   ...
   *
   * \return the Wi-Fi standard
   */
  virtual enum WifiPhyStandard GetCurrentStandard (void) const;
  ...
  */
  ...
  void SetFrameMinBer (double per);
  double GetFrameMinBer (void) ;
