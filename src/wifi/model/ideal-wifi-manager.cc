...
TypeId IdealWifiManager::GetTypeId (void)
{
...
void IdealWifiManager::SetupPhy(Ptr<WifiPhy> phy)
{
...
double IdealWifiManager::GetSnrThreshold (WifiMode mode) const
{
...
void IdealWifiManager::AddModeSnrThreshold(WifiMode mode, double snr)
{
    m_thresholds.push_back(std::make_pair(snr,mode));
}

WifiRemoteStation *IdealWifiManager::DoCreateStation (void) const
{
...
void IdealWifiManager::DoReportRxOk(WifiRemoteStation *station, double rxSnr, WifiMode txMode)
{}
...
void IdealWifiManager::DoReportRtsOk(WifiRemoteStation *st,
...
WifiTxVector IdealWifiManager::DoGetRtsTxVector (WifiRemoteStation *st)
{
	...
	double threshold = GetSnrThreshold (mode);
	if (threshold > maxThreshold && threshold < station->m_lastSnr)
	{
	    maxThreshold = threshold;
	    maxMode = mode;
	}
...
bool IdealWifiManager::IsLowLatency (void) const
{
    return true;
}
