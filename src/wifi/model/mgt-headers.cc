...
void MgtProbeRequestHeader::SetSsid (Ssid ssid)
{
    m_ssid = ssid;
}

Ssid MgtProbeRequestHeader::GetSsid (void) const
{
    return m_ssid;
}

void MgtProbeRequestHeader::SetSupportedRates (SupportedRates rates)
{
    m_rates = rates;
}

void MgtProbeRequestHeader::SetHtCapabilities(HtCapabilities htcapabilities)
{
    m_htCapability=htcapabilities;
}

HtCapabilities MgtProbeRequestHeader::GetHtCapabilities (void) const
{
    return  m_htCapability;
}

SupportedRates MgtProbeRequestHeader::GetSupportedRates (void) const
{
    return m_rates;
}

uint32_t MgtProbeRequestHeader::GetSerializedSize (void) const
{
    uint32_t size = 0;
...
TypeId MgtProbeRequestHeader::GetTypeId (void)
{
...
TypeId MgtProbeRequestHeader::GetInstanceTypeId (void) const
{
    return GetTypeId ();
}

void MgtProbeRequestHeader::Print(std::ostream &os) const
{
    os << "ssid=" << m_ssid << ", "
     << "rates=" << m_rates << ", "
...
void MgtProbeRequestHeader::Serialize(Buffer::Iterator start) const
{
...
uint32_t MgtProbeRequestHeader::Deserialize(Buffer::Iterator start)
{
    Buffer::Iterator i = start;
...
uint64_t MgtProbeResponseHeader::GetTimestamp ()
{
    return m_timestamp;
}

Ssid MgtProbeResponseHeader::GetSsid (void) const
{
    return m_ssid;
}

uint64_t MgtProbeResponseHeader::GetBeaconIntervalUs (void) const
{
    return m_beaconInterval;
}

SupportedRates MgtProbeResponseHeader::GetSupportedRates (void) const
{
    return m_rates;
}

void  MgtProbeResponseHeader::SetHtCapabilities(HtCapabilities htcapabilities)
{
    m_htCapability=htcapabilities;
}
