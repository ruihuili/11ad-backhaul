...
Time WifiMac::GetDefaultMaxPropagationDelay (void)
{
    // 1000m
    return Seconds(1000.0 / 300000000.0);
}

Time WifiMac::GetDefaultSlot (void)
{
    // 802.11-a specific
    return MicroSeconds(9);
}

Time WifiMac::GetDefaultSifs (void)
{
    // 802.11-a specific
    return MicroSeconds(16);
}

Time WifiMac::GetDefaultRifs (void)
{
    //802.11n specific
    return MicroSeconds(2);
}

Time WifiMac::GetDefaultEifsNoDifs (void)
{
    return GetDefaultSifs() + GetDefaultCtsAckDelay();
}

Time WifiMac::GetDefaultCtsAckDelay (void)
{
    // 802.11-a specific: 6mb/s
    return MicroSeconds(44);
}

Time WifiMac::GetDefaultCtsAckTimeout (void)
{
...
Time WifiMac::GetDefaultBasicBlockAckDelay (void)
{
    // This value must be rivisited
    return MicroSeconds (250);
}

Time WifiMac::GetDefaultCompressedBlockAckDelay (void)
{
...
Time WifiMac::GetDefaultBasicBlockAckTimeout (void)
{
...
Time WifiMac::GetDefaultCompressedBlockAckTimeout (void)
{
    Time blockAckTimeout = GetDefaultSifs ();
...
void WifiMac::SetBasicBlockAckTimeout(Time blockAckTimeout)
{
    //this method must be implemented by QoS WifiMacs.
}

Time WifiMac::GetBasicBlockAckTimeout(void) const
{
    //this method must be implemented by QoS WifiMacs.
    return MicroSeconds (0);
}

void WifiMac::SetCompressedBlockAckTimeout(Time blockAckTimeout)
{
    //this methos must be implemented by QoS WifiMacs.
}

Time WifiMac::GetCompressedBlockAckTimeout(void) const
{
    //this method must be implemented by QoS WifiMacs.
    return MicroSeconds(0);
}

TypeId WifiMac::GetTypeId(void)
{
...
void WifiMac::SetMaxPropagationDelay(Time delay)
{
    m_maxPropagationDelay = delay;
}

Time WifiMac::GetMsduLifetime (void) const
{
    return Seconds(10);
}

Time WifiMac::GetMaxPropagationDelay (void) const
{
    return m_maxPropagationDelay;
}

void WifiMac::NotifyTx(Ptr<const Packet> packet)
{
    m_macTxTrace (packet);
}
...
void WifiMac::NotifyRx(Ptr<const Packet> packet)
{
    m_macRxTrace(packet);
}
...
void WifiMac::ConfigureStandard(enum WifiPhyStandard standard)
{
    switch (standard)
    {
...
void WifiMac::Configure80211a (void)
{
...
void WifiMac::Configure80211b (void)
{
...
void WifiMac::Configure80211g(void)
{
    SetSifs (MicroSeconds (10));
...
void WifiMac::Configure80211_10Mhz(void)
{
...
void WifiMac::Configure80211_5Mhz(void)
{
...
void WifiMac::Configure80211n_2_4Ghz(void)
{
    Configure80211g ();
...
void WifiMac::Configure80211n_5Ghz(void)
{
    Configure80211a ();
    SetRifs(MicroSeconds (2));
    SetCtsTimeout (MicroSeconds (10 + 52 + 20 + GetDefaultMaxPropagationDelay ().GetMicroSeconds () * 2));
 ...
 */
void WifiMac::Configure80211ad(void)
{
    ...
    /* 242 ns for ACK using MCS13, plus preamble and PLCP header */
    SetEifsNoDifs(GetSifs() + NanoSeconds(2229));
    SetCtsTimeout(GetSifs() + NanoSeconds(2229) + GetSlot() + GetMaxPropagationDelay() * 2);
    SetAckTimeout(GetSifs() + NanoSeconds(2229) + GetSlot() + GetMaxPropagationDelay() * 2);
}

void WifiMac::ConfigureDcf(Ptr<Dcf> dcf, uint32_t cwmin, uint32_t cwmax, enum AcIndex ac)
{
