...
/*
 * Enumeration for Type Field within Frame Control.
 */
enum
{
    TYPE_MGT = 0,
...
/*
 * Enumeration for Subtype Field within Frame Control.
 */
enum
{
...
void WifiMacHeader::SetDsFrom (void)
{
    m_ctrlFromDs = 1;
}

void WifiMacHeader::SetDsNotFrom (void)
{
    m_ctrlFromDs = 0;
}

void WifiMacHeader::SetDsTo (void)
{
    m_ctrlToDs = 1;
}

void WifiMacHeader::SetDsNotTo (void)
{
    m_ctrlToDs = 0;
}

void WifiMacHeader::SetAddr1 (Mac48Address address)
{
    m_addr1 = address;
}

void WifiMacHeader::SetAddr2 (Mac48Address address)
{
    m_addr2 = address;
}

void WifiMacHeader::SetAddr3 (Mac48Address address)
{
    m_addr3 = address;
}

void WifiMacHeader::SetAddr4 (Mac48Address address)
{
    m_addr4 = address;
}

void WifiMacHeader::SetAssocReq (void)
{
    m_ctrlType = TYPE_MGT;
    m_ctrlSubtype = 0;
}

void WifiMacHeader::SetAssocResp (void)
{
    m_ctrlType = TYPE_MGT;
    m_ctrlSubtype = 1;
}

void WifiMacHeader::SetProbeReq (void)
{
    m_ctrlType = TYPE_MGT;
    m_ctrlSubtype = 4;
}

void WifiMacHeader::SetProbeResp (void)
{
    m_ctrlType = TYPE_MGT;
    m_ctrlSubtype = 5;
}

void WifiMacHeader::SetBeacon (void)
{
    m_ctrlType = TYPE_MGT;
    m_ctrlSubtype = 8;
}

void WifiMacHeader::SetDMGBeacon (void)
{
    m_ctrlType = TYPE_Extension;
    m_ctrlSubtype = 0;
}

void WifiMacHeader::SetBlockAckReq (void)
{
    m_ctrlType = TYPE_CTL;
    m_ctrlSubtype = 8;
}

void WifiMacHeader::SetBlockAck (void)
{
    m_ctrlType = TYPE_CTL;
    m_ctrlSubtype = 9;
}

void WifiMacHeader::SetTypeData (void)
{
    m_ctrlType = TYPE_DATA;
    m_ctrlSubtype = 0;
}

void WifiMacHeader::SetAction (void)
{
    m_ctrlType = TYPE_MGT;
    m_ctrlSubtype = 0x0D;
}

void WifiMacHeader::SetMultihopAction (void)
{
    m_ctrlType = TYPE_MGT;
    m_ctrlSubtype = 0x0F;
}

void WifiMacHeader::SetType(enum WifiMacType type)
{
    switch (type)
    {
	/*
	 * 802.11 MAC Control Frames.
	 */
	...
	/*
	 * New 802.11ad MAC Control Frames.
	 */
...
void WifiMacHeader::SetQosNormalAck ()
{
    m_qosAckPolicy = 0;
}

void WifiMacHeader::SetQosBlockAck ()
{
    m_qosAckPolicy = 3;
}
...
Mac48Address WifiMacHeader::GetAddr1 (void) const
{
    return m_addr1;
}

Mac48Address WifiMacHeader::GetAddr2 (void) const
{
    return m_addr2;
}

Mac48Address WifiMacHeader::GetAddr3 (void) const
{
    return m_addr3;
}

Mac48Address WifiMacHeader::GetAddr4 (void) const
{
    return m_addr4;
}

enum WifiMacType WifiMacHeader::GetType (void) const
{
    switch (m_ctrlType)
    {
	case TYPE_MGT:
...
bool WifiMacHeader::IsFromDs (void) const
{
  return m_ctrlFromDs == 1;
}

bool WifiMacHeader::IsToDs (void) const
{
  return m_ctrlToDs == 1;
}

bool WifiMacHeader::IsData (void) const
{
    return (m_ctrlType == TYPE_DATA);
}

bool WifiMacHeader::IsQosData (void) const
{
    return (m_ctrlType == TYPE_DATA && (m_ctrlSubtype & 0x08));
}

bool WifiMacHeader::IsCtl(void) const
{
    return (m_ctrlType == TYPE_CTL);
}

bool WifiMacHeader::IsMgt(void) const
{
    return (m_ctrlType == TYPE_MGT);
}

bool WifiMacHeader::IsExtension(void) const
{
    return (m_ctrlType == TYPE_Extension);
}

bool WifiMacHeader::IsCfpoll (void) const
{
  switch (GetType ())
    {
    case WIFI_MAC_DATA_CFPOLL:
...
bool WifiMacHeader::IsBeacon (void) const
{
    return (GetType () == WIFI_MAC_MGT_BEACON);
}

bool WifiMacHeader::IsDisassociation (void) const
{
...
bool WifiMacHeader::IsDMGBeacon (void) const
{
    return (GetType() == WIFI_MAC_EXTENSION_DMG_BEACON);
}

uint16_t WifiMacHeader::GetRawDuration (void) const
{
    return m_duration;
}

Time WifiMacHeader::GetDuration (void) const
{
    return MicroSeconds(m_duration);
}

uint16_t WifiMacHeader::GetSequenceControl (void) const
{
    return(m_seqSeq << 4) | m_seqFrag;
}

uint16_t WifiMacHeader::GetSequenceNumber (void) const
{
  return m_seqSeq;
}
...
enum WifiMacHeader::QosAckPolicy WifiMacHeader::GetQosAckPolicy (void) const
{
...
uint8_t WifiMacHeader::GetQosTxopLimit(void) const
{
    NS_ASSERT(IsQosData());
    return m_qosStuff;
}

uint16_t WifiMacHeader::GetFrameControl(void) const
{
    uint16_t val = 0;
...
uint16_t WifiMacHeader::GetQosControl (void) const
{
    uint16_t val = 0;
    val |= m_qosTid;
    val |= m_qosEosp << 4;
...
TypeId WifiMacHeader::GetTypeId (void)
{
...
TypeId WifiMacHeader::GetInstanceTypeId (void) const
{
    return GetTypeId();
}
...
void WifiMacHeader::Print(std::ostream &os) const
{
	...
	os << ", FragNumber=" << std::hex << (int) m_seqFrag << std::dec << ", SeqNumber=" << m_seqSeq;
	break;
...
uint32_t WifiMacHeader::GetSerializedSize(void) const
{
    return GetSize();
}
...
void WifiMacHeader::Serialize(Buffer::Iterator i) const
{
    ...
    WriteTo(i, m_addr1);
    //NS_LOG_DEBUG(Simulator::Now () <<" ctrlType "<< (uint16_t) m_ctrlType << " ctrlsubType "<< (uint16_t)m_ctrlSubtype<<" m_address1 "<< m_addr1 <<" m_address2 "<< m_addr2 <<" m_address3 "<< m_addr3);
    switch (m_ctrlType)
    {
	case TYPE_MGT:
	{
	...
	case TYPE_CTL:
	{
		...
		case SUBTYPE_CTL_EXTENSION:
		{
			...
			case SUBTYPE_CTL_EXTENSION_GRANT:
			    WriteTo(i, m_addr2); // TA Address Field.
			    //i.Write(m_dynamicAllocation); // Dynamic Allocation Info Field.
			    i.WriteHtolsbU16(m_bfControl); // BF Control Field defined in 8.4a.5.
			    break;
			...
			case SUBTYPE_CTL_EXTENSION_DMG_DTS:
			    WriteTo(i, m_navSA); // NAV-SA.
			    WriteTo(i, m_navDA); // NAV-DA.
			    break;

			case SUBTYPE_CTL_EXTENSION_GRANT_ACK:
			    WriteTo(i, m_addr2); // TA Address Field.
			    //WriteTo(i, m_reserved); // Rserved Field.
			    i.WriteHtolsbU16(m_bfControl); // BF Control Field defined in 8.4a.5.
			    break;

			case SUBTYPE_CTL_EXTENSION_SSW:
			    WriteTo(i, m_addr2); // TA Address Field.
			    //WriteTo(i, m_ssw); // SSW Field defined in 8.4a.1.
			    //WriteTo(i, m_sswFBCK); // SSW Feedback Field defined in 8.4a.3.
			    break;
			...
			case SUBTYPE_CTL_EXTENSION_SSW_ACK:
			    WriteTo(i, m_addr2); // TA Address Field.
			    //WriteTo(i, m_sswFBCK); // SSW Feedback Field defined in 8.4a.3.
			    //WriteTo(i, m_brpRequest); // BRP Request Field defined in 8.4a.4.
			    i.WriteHtolsbU16(m_beamformedLinkMaintenance); // Beamoformed Link Maintenance Field defined in 8.4a.6.
			    break;
...
uint32_t WifiMacHeader::Deserialize(Buffer::Iterator start)
{
    ...
    ReadFrom(i, m_addr1);
    //NS_LOG_UNCOND(Simulator::Now () <<" ctrlType "<< (uint16_t) m_ctrlType << " ctrlsubType "<< (uint16_t)m_ctrlSubtype<<" m_address1 "<< m_addr1 <<" m_address2 "<< m_addr2 <<" m_address3 "<< m_addr3);
	...
	case TYPE_CTL:
	{
		...
		case SUBTYPE_CTL_EXTENSION:
		{
			...
			case SUBTYPE_CTL_EXTENSION_GRANT:
			    ReadFrom(i, m_addr2); // TA Address Field.
			    //ReadFrom(i, m_dynamicAllocation); // Dynamic Allocation Info Field.
			    m_bfControl = i.ReadLsbtohU16(); // BF Control Field defined in 8.4a.5.
			    break;
			...
			case SUBTYPE_CTL_EXTENSION_DMG_DTS:
			    ReadFrom(i, m_navSA); // NAV-SA.
			    ReadFrom(i, m_navDA); // NAV-DA.
			    break;

			case SUBTYPE_CTL_EXTENSION_GRANT_ACK:
			    ReadFrom(i, m_addr2); // TA Address Field.
			    //ReadFrom(i, m_reserved); // Rserved Field.
			    m_bfControl = i.ReadLsbtohU16(); // BF Control Field defined in 8.4a.5.
			    break;

			case SUBTYPE_CTL_EXTENSION_SSW:
			    ReadFrom(i, m_addr2); // TA Address Field.
			    //ReadFrom(i, m_ssw); // SSW Field defined in 8.4a.1.
			    //ReadFrom(i, m_sswFBCK); // SSW Feedback Field defined in 8.4a.3.
			    break;
			...
			case SUBTYPE_CTL_EXTENSION_SSW_ACK:
			    ReadFrom(i, m_addr2); // TA Address Field.
			    //ReadFrom(i, m_sswFBCK); // SSW Feedback Field defined in 8.4a.3.
			    //ReadFrom(i, m_brpRequest); // BRP Request Field defined in 8.4a.4.
			    m_beamformedLinkMaintenance = i.ReadU8(); // Beamoformed Link Maintenance Field defined in 8.4a.6.
			    break;
		...
		default:
		    //NOTREACHED
		    //NS_ASSERT(false); //!!!!!!!RUI LI 17/01/2017
		    break;
	    }
	} break;
