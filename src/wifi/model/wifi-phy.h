...
public:
  ...
  */
   ...
   */
  virtual enum WifiPhyStandard GetCurrentStandard (void) const = 0;
  /**
  ...
  /**
   * Return a WifiMode for OFDM and SC for 802.11ad.
   */
...
private:
  ...
  double m_totalAmpduNumSymbolsDmg;
  double m_totalAmpduSizeDmg;

protected:
  enum WifiPhyStandard m_standard; //!< Current PHY standard.
