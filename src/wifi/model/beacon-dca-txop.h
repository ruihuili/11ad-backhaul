...
#ifndef BEACON_DCA_TXOP_H
#define BEACON_DCA_TXOP_H
 ...
 */
class BeaconDcaTxop : public Dcf
{
public:
  ...
  /**
   * Set BeamformingEngine this BeaconDcaTxop is associated to.
   *
   * \param beamformingEngine BeamformingEngine
   */
  void SetBeamformingEngine (BeamformingEngine *beamformingEngine);
