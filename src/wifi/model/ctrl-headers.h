 ...
 */
class CtrlDMG_Poll : public Header
{
public:
    CtrlDMG_Poll();
    ~CtrlDMG_Poll();
...
private:
    DMG_SSW_FBCK_Field m_sswFBCK;
    BRP_Request_Field m_brp;
    BF_Link_Maintenance_Field m_bfLink;
...
/**
 * \ingroup wifi
 * \brief Header for Sector Grant ACK Frame.
 */
class CtrlGrant_ACK : public Header
{
public:
    CtrlGrant_ACK();
    ~CtrlGrant_ACK();
