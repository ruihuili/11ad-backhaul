 ...
 */
#ifndef DASH_RATE_ADAPTATION_HELPER_H
#define DASH_RATE_ADAPTATION_HELPER_H
 ...
 * on a set of nodes.
 */
class DashRateAdaptationHelper
{
public:
  /**
   * Create an DashRateAdaptationHelper to make it easier to work with OnOffApplications
   *
   ...
   *        to.
   */
  DashRateAdaptationHelper (std::string protocol, Address address);
...
#endif /* DASH_RATE_ADAPTATION_HELPER_H */
