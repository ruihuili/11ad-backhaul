...
private:
  double m_range; //!< Maximum Transmission Range (meters)
     ...
     *
*/
    class FriisLoSPropagationLossModel : public PropagationLossModel
    {
    public:
        /**
         * \brief Get the type ID.
        ...
        void SetLoS (Ptr<MobilityModel> a, Ptr<MobilityModel> b, bool los);
    ...
    private:
         ...
         * Defined and unimplemented to avoid misuse
         */
        FriisLoSPropagationLossModel (const FriisLoSPropagationLossModel &);
        /**
         * \brief Copy constructor
         *
         * Defined and unimplemented to avoid misuse
         * \returns
         */
        FriisLoSPropagationLossModel & operator = (const FriisLoSPropagationLossModel &);
        ...
        std::map<MobilityPair, bool> m_los; //!< Propagation loss between pair of nodes
    };
